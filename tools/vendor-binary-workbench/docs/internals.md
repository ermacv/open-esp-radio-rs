...
| `facts/parse.rs` | Strict schema-v44 linked-IR projection, including indexed/dereferenced/allocation memory objects, site-bearing calls, typed diagnostics and guard expressions |
...
| `artifacts/linked_ir_document.rs` | Persistent schema-v44 Serde document |
...
Since schema v42 the current schema-v44 artifact serializes the typed
