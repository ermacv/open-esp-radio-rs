...
use open_esp_radio_ieee80211::{
    scan::ScanRecord,
    station::{
        AssociationResponse, StaAssociationPreference, StaSecurityError, StaTxSequenceCounters,
        select_sta_association, select_wpa2_psk_rsn,
    },
};
use open_esp_radio_wifi_lifecycle::station::StaFailureDisposition;
...
use crate::{
    ...
    sta_attempt::{
        Esp32s31StaAttemptPort, Esp32s31StaAttemptStepError, Esp32s31StaConnectedEntryFailure,
    },
    sta_join::{
        EmbassyStaJoinTimer, StaAssociationSuccess, StaAuthenticationSuccess, StaJoinError,
        StaJoinRunner,
    },
    sta_join_port::{
        Esp32s31StaJoinObserver, Esp32s31StaJoinPort, Esp32s31StaJoinPortError,
        Esp32s31StaJoinRadio, Esp32s31StaJoinRx, Esp32s31StaJoinStation, Esp32s31StaJoinStorage,
        Esp32s31StaJoinTransmit,
    },
    sta_peer_port::{
        Esp32s31ConnectedStaPeer, Esp32s31PreparedStaPeer, Esp32s31ProgrammedStaPeer,
        Esp32s31StaPeerPort, Esp32s31StaPeerPortError, Esp32s31StaPeerProgrammingReport,
        Esp32s31StaPeerRadio, Esp32s31StaPeerStation, Esp32s31StaPeerTransmit,
    },
    sta_scan_target::Esp32s31ScanPhy,
    wpa2::{
        EmbassyWpa2HandshakeTimer, Wpa2Established, Wpa2HandshakeConfig, Wpa2HandshakeError,
        Wpa2HandshakeRunner, Wpa2KeyInstallError, Wpa2KeyInstallMetadata, Wpa2KeyInstallRunner,
        Wpa2PendingKeyInstall,
    },
    wpa2_port::{
        Esp32s31InstalledWpa2Keys, Esp32s31Wpa2HandshakePort, Esp32s31Wpa2HandshakePortError,
        Esp32s31Wpa2HandshakeRadio, Esp32s31Wpa2HandshakeStorage, Esp32s31Wpa2HandshakeTelemetry,
        Esp32s31Wpa2KeyPort, Esp32s31Wpa2KeyPortError, Esp32s31Wpa2KeyRadio,
...
/// Coherent owner consumed by [`crate::sta_attempt::Esp32s31StaAttempt`].
...
/// Connected-entry proof returned only after all seven preceding phases.
    ...
    > + '_ {
        async move {
            ...
            match missing {
                ...
                None => Ok(Esp32s31StaAttemptConnected { owner }),
            }
        }
    }
}
