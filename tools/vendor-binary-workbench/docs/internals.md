...
| `facts/parse.rs` | Strict schema-v48 overview/full-function projections, including indexed/dereferenced/allocation memory objects, site-bearing calls, typed diagnostics and guard expressions |
...
| `artifacts/linked_ir_document.rs` | Persistent schema-v48 Serde document and compact review projection; artifact-wide transitive closures are explicitly on demand |
...
Since schema v42 the current schema-v48 artifact serializes the typed
