...
Projects require metadata schema 14 and journal schema 15; earlier/future formats
...
Run schema 15 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 14.
