...
pub struct BasebandInitializationReport {
    ...
    ControllerBasebandInitialized<P, MODEM_TIMER_CAPACITY, SCHEDULER_CAPACITY>
{
    ...
    pub const fn baseband_report(&self) -> BasebandInitializationReport {
    ...
    ControllerPhyInitialized<P, MODEM_TIMER_CAPACITY, SCHEDULER_CAPACITY>
{
    ...
    pub fn initialize_baseband(
        ...
        ControllerBasebandInitialized {
            initialized: ControllerPhyInitialized {
                controller,
                phy,
                calibration_cache,
                report,
...
fn apply_baseband_input(
    phy: &oer_esp32s31_phy::PhyState,
    initialize: impl FnOnce(u8),
) -> BasebandInitializationReport {
    let report = BasebandInitializationReport {
