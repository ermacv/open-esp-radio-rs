    ...
    T: WifiTxTimer,
{
    ...
    pub async fn service<H: TxHardware>(
        ...
        let tx_events = interrupt_events
            & (open_esp_radio_esp32s31_wifi_lmac::irq::MAC_INT_TX_COMPLETE
                | open_esp_radio_esp32s31_wifi_lmac::irq::MAC_INT_TX_TIMEOUT
                | open_esp_radio_esp32s31_wifi_lmac::irq::MAC_INT_COLLISION);
