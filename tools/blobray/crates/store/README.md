...
Projects require metadata schema 15 and journal schema 16; earlier/future formats
...
Run schema 16 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 15.
