//! Verification of the source-owned MAC slice replacing `wDev_ProcessFiq`.
//!
...
//! prerequisites; later adapters must verify them before those domains can be
...
pub fn verify_esp32s31_wdev_process_fiq_mac_slice(
    ...
    Ok(DriverAdapterVerification::from_trust(
        crate::driver_adapter_trust("esp32s31-wdev-process-fiq-mac-slice-v1")
