...
| Passive-scan records, beacon/probe-response parsing, BSS de-duplication and selection | `crates/open-esp-radio-mac-esp32s31/src/scan.rs` | Open RX passive scan passed across 2.4 GHz channels 1–13 |
...
| 802.11 framing and state | `net80211_*.rs`, `beacon.rs`, `he.rs`, `rate_*.rs` | live MAC crate |
