...
The schema-v52 random-access bundle stores pseudo-Rust with each function.
...
Artifact identities and digests remain embedded in the schema-v52 report, so a
...
generated linked-IR bundle remains a separate schema-v52 project artifact; the
...
valid schema-v52 output. It also reports whether the bundle is linked into
