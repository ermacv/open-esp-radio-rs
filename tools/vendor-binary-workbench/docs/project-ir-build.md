...
`pseudo-rust` is optional; schema-v31 JSON is always generated.
...
Artifact identities and digests remain embedded in the schema-v31 report, so a
...
valid entry contract, generated schema-v31 output and an optional pseudo-Rust
