...
//!
//! ```compile_fail
//! use oer_esp32s31_phy::RegisteredIeee802154Clocked;
//!
...
//!
//! ```compile_fail
//! use oer_esp32s31_hal::ieee802154::Ieee802154Clocked;
...
//!
//! ```compile_fail
//! use oer_esp32s31_phy::RegisteredIeee802154ResetTransitionFailure;
//!
...
use oer_esp32s31_hal::owner::SharedPhyHal;
