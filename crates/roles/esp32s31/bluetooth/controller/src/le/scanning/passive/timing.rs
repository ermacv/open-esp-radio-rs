...
#[cfg(target_arch = "riscv32")]
use {
    crate::le::scanning::scheduler::PassiveScanFirstEventCandidate,
    oer_esp32s31_bluetooth::{ControllerSchedulerEpoch, scheduler::SchedulerRawWindow},
};

use oer_esp32s31_bluetooth::{SchedulerInstant, scheduler::SchedulerSoftwareConfig};
