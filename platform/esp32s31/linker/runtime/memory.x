...
MEMORY
{
  ...
  /* Addresses and sizes are `oer-esp32s31-platform-layout` symbols. The
     runtime profile selects ordinary code as Flash XIP at the embedded-payload address
  ...
  PSRAM_EXTERNAL (RWX) : ORIGIN = RUNTIME_PSRAM_ORIGIN, LENGTH = RUNTIME_PSRAM_LENGTH
}
