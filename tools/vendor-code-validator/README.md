...
| `registers init-model` / `import-svd` / `validate` / `export-svd` / `generate-pac` | Maintain the reviewed register model and derive clean SVD/PAC outputs | [Register workspace](docs/register-workspace.md) |
