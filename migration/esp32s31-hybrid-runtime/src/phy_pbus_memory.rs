...
mod tests {
    use super::{
        PhyPbusMemoryAction, PhyPbusMemoryCompletion, PhyPbusMemoryOutcome,
        PhyPbusMemoryParameters, PhyPbusMemoryTransition, PhyPbusMemoryTransitionError,
        PHY_PBUS_MEMORY_ENTRY_COUNT, PHY_PBUS_MEMORY_SAVED_ADDRESSES,
    };
