...
pub fn task_poll_markdown(task_polls: TaskPollSet) -> String {
...
pub fn udp_sequence_markdown(sequence: UdpSequenceEvidence, host_datagrams: u64) -> String {
...
pub fn rx_order_markdown(order: RxOrderEvidence) -> String {
...
pub fn rx_reorder_markdown(reorder: RxReorderEvidence) -> String {
    format!(
        "## RX BlockAck reorder\n\n\
