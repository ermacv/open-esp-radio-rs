...
The machine report uses schema 18. It separates the complete finding inventory from the
...
selections over the same inventory share one identity. The digest is
...
reproducible action reports. File generation and checking stream serialization
