...
The schema-v51 random-access bundle stores pseudo-Rust with each function.
...
Artifact identities and digests remain embedded in the schema-v51 report, so a
...
generated linked-IR bundle remains a separate schema-v51 project artifact; the
...
valid schema-v51 output. It also reports whether the bundle is linked into
