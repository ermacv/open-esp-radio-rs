...
fn semantic_transmitter_command_projects_exactly_once_into_typed_chip_inputs() {
    ...
    assert_eq!(program.pattern, DtmPayloadPattern::Repeated01010101);
    assert_eq!(program.phy, DtmPhy::Le1M);
...
fn enhanced_commands_project_all_reviewed_phy_modes() {
    for (selector, expected) in [(1, DtmPhy::Le1M), (2, DtmPhy::Le2M), (3, DtmPhy::LeCoded)] {
