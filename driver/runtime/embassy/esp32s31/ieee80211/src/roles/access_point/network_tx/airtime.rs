...
use open_esp_radio_esp32s31_wifi_ap::ampdu::Esp32s31ApAmpduBudget;
use open_esp_radio_esp32s31_wifi_mac::tx::HtRate;
pub use open_esp_radio_wifi_datapath::airtime::{AirtimeAction, AirtimeObservation};
use open_esp_radio_wifi_datapath::airtime::{
...
impl From<AccessPointAirtimeError> for Esp32s31AccessPointDatapathError {
...
impl<'a> Accounting<'a> {
    ...
    fn cap_aggregate(
        ...
        rate: HtRate,
        budget: &mut Esp32s31ApAmpduBudget,
...
impl<B: StableDmaBacking, N> Esp32s31AccessPointNetworkTx<'_, B, N> {
    pub(super) fn ordinary_airtime_result(
        &mut self,
        result: Result<WifiTxProgress, Esp32s31AccessPointControlError>,
        ...
        result.map_err(Esp32s31AccessPointDatapathError::Control)
    }
}
