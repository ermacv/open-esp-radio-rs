...
pub(super) fn provenance_summary(report: &LinkedIrReport) -> (usize, usize, usize, usize, usize) {
...
pub(super) fn field_candidate_summary(report: &LinkedIrReport) -> (usize, usize, usize, usize) {
