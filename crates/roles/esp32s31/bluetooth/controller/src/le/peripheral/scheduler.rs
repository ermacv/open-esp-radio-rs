...
#[cfg(target_arch = "riscv32")]
use oer_esp32s31_bluetooth::scheduler::core::SchedulerHeadPublicationError;
...
impl PeripheralConnectionEventPrepared {
    #[cfg(test)]
    pub(crate) const fn requested_window(
        &self,
    ) -> oer_esp32s31_bluetooth::scheduler::SchedulerRawWindow {
        self.event.requested_window()
    }

    #[cfg(test)]
    pub(crate) const fn resolved_window(
        &self,
    ) -> oer_esp32s31_bluetooth::scheduler::SchedulerRawWindow {
