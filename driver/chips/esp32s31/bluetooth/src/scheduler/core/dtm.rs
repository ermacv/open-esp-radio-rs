...
use super::{
    BluetoothControllerTimeAcquisitionError, BluetoothSchedulerEmptyListMergeError,
...
use crate::{BluetoothControllerPoweredTaskRuntime, BluetoothDtmRole};
#[cfg(any(target_arch = "riscv32", test))]
use crate::{
    BluetoothControllerTimeSample, BluetoothSchedulerInstant, BluetoothSchedulerTimingPolicy,
    controller::time::BluetoothControllerSchedulerNow,
    scheduler::timeline::{
...
#[cfg(any(target_arch = "riscv32", test))]
use crate::{
    BluetoothDtmSchedulerItemEvent, BluetoothDtmSchedulerReservation,
    BluetoothDtmSchedulerSequenceAuthorizationFailure, BluetoothSchedulerReservationError,
...
use open_esp_radio_esp32s31_hal::{
    BluetoothControllerSramAddress, BluetoothSchedulerHardwareListHeadPublished,
...
#[cfg(any(target_arch = "riscv32", test))]
pub(super) const fn dtm_scheduler_current(
