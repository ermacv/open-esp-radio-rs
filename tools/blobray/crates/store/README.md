...
Projects require metadata schema 23 and journal schema 24; earlier/future formats
...
Run schema 24 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 23.
