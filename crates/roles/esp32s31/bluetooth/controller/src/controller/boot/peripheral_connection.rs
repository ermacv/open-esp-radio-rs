...
use {
    crate::le::peripheral::PeripheralConnectionSchedulerCompletionClassification,
    oer_esp32s31_bluetooth::controller_time::{
...
pub(crate) enum PeripheralConnectionControllerPreparationFailStopCause {
    ControllerTime(oer_esp32s31_bluetooth::scheduler::ControllerTimeAcquisitionError),
    PhaseOwnership,
}
    ...
    ControllerPublishedTaskService<'runtime, S, SCHEDULER_CAPACITY>
{
    ...
    pub(crate) fn peripheral_supervision_deadline(
        ...
        let reference = crate::le::peripheral::supervision::supervision_reference(
            oer_esp32s31_bluetooth::SchedulerInstant::from_image(
    ...
    ControllerSchedulerNowReady<'runtime, S, SCHEDULER_CAPACITY>
{
    ...
    pub(crate) fn peripheral_current_instant(&self) -> oer_esp32s31_bluetooth::SchedulerInstant {
        oer_esp32s31_bluetooth::SchedulerInstant::from_image(
            self.epoch.project_without_reanchor(&self.sample),
        )
    }
