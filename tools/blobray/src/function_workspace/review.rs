...
fn function_memory_object_label(object: &super::FunctionMemoryObjectFact) -> String {
    match object {
        ...
        super::FunctionMemoryObjectFact::OpaqueExternalObject { call_token } => {
