...
Projects require metadata schema 16 and journal schema 17; earlier/future formats
...
Run schema 17 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 16.
