...
use summaries::{
    reference_intrinsic_trace, standard_memory_intrinsic_trace, wide_signed_divide_intrinsic,
};
...
use crate::{
    ...
    Rv32CallArguments, SECONDARY_CALL_RESULT_TOKEN_FLAG, SymbolicValue, artifact, entry_contract,
    execution, external_abi, reference_event_is_mmio_read, reference_flow_calls_are_valid,
};
...
pub(crate) fn resolve_reference_trace(
    ...
    if let Some(mut trace) = reference_intrinsic_trace(symbol, svd, pointer_context) {
