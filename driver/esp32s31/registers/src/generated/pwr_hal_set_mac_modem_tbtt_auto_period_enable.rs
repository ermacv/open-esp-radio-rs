...
// Source vendor symbol: pwr_hal_set_mac_modem_tbtt_auto_period_enable
use open_esp_radio_esp32s31_pac as pac;

#[inline(always)]
pub fn generated_pwr_hal_set_mac_modem_tbtt_auto_period_enable(
    ...
    unsafe {
        wifi_mac_regdma_control_registers
            ...
            .write_with_zero(|writer| {
                writer.bits(((read0 & 0x7fffffff_u32) | 0x80000000_u32) as u32)
            });
    }
    arg0
}
