...
pub use open_esp_radio_esp32s31_pac::{
    ...
    MacHeTxVectorSnapshot, MacHtAmpduCompletionObservation, MacHtChannelWidth, MacHtGuardInterval,
    MacHtMcs, MacHtProtectionSpacing, MacHtRate, MacHtTxFormat, MacHtTxParameters, MacHtTxProgram,
    MacInterface, MacInterruptEvents, MacInterruptMask, MacInterruptObservation,
    MacInterruptSnapshot, MacItwtClearIndex, MacKeyEntryIndex, MacKeyInstallOutcome, MacLegacyRate,
    MacLegacyTxParameters, MacLegacyTxProgram, MacPartialRuPowerSelector,
    MacPowerInterruptSnapshot, MacPti, MacRoleReceivePolicy, MacRxBlockAckEntryIndex,
