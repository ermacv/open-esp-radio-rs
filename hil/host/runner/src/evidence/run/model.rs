...
impl SuiteCounts {
    pub(crate) fn from_results(results: &[ScenarioResult]) -> Self {
        let mut counts = Self {
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub(crate) struct FirmwareReplayOrigin {
    pub(crate) source_run_id: String,
    pub(crate) source_integrity_sha256: String,
    pub(crate) firmware_repository: RepositoryProvenance,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) source_build_id: Option<String>,
}
...
#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub(crate) struct CellProvenance {
    pub(crate) cell_id: String,
    pub(crate) device_id: String,
    pub(crate) serial_device: PathBuf,
}
...
pub(crate) struct FirmwareArtifact {
    pub(crate) image: ImageClass,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) replayed_from: Option<FirmwareReplayOrigin>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) build_id: Option<String>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) build_provenance_path: Option<PathBuf>,
    pub(crate) application_path: PathBuf,
    pub(crate) application_size_bytes: u64,
    pub(crate) application_sha256: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) runtime_elf_path: Option<PathBuf>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) runtime_elf_size_bytes: Option<u64>,
    pub(crate) runtime_elf_sha256: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) runtime_bin_path: Option<PathBuf>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) runtime_bin_size_bytes: Option<u64>,
    pub(crate) runtime_bin_sha256: String,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) bootstrap_elf_path: Option<PathBuf>,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) bootstrap_elf_size_bytes: Option<u64>,
    pub(crate) bootstrap_elf_sha256: String,
}
...
pub(crate) struct RunManifest {
    ...
    pub(crate) cell: CellProvenance,
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub(crate) lab_provenance_path: Option<PathBuf>,
    pub(crate) firmware: Vec<FirmwareArtifact>,
}
