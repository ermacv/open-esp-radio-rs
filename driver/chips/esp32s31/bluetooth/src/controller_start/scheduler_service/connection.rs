...
pub(crate) type BluetoothPeripheralConnectionRecurringSchedulerStartOutcome<E> = ControlFlow<
    crate::scheduler::BluetoothPeripheralConnectionRecurringSchedulerValidationFailure,
    ControlFlow<
        (
            E,
            crate::scheduler::BluetoothPeripheralConnectionRecurringEmptySchedulerMergePrepared,
        ),
        ControlFlow<
            crate::scheduler::BluetoothPeripheralConnectionRecurringSchedulerPublicationFailStop,
