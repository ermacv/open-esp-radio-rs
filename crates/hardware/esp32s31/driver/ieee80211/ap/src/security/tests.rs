...
fn rx_replay_is_per_tid_and_fenced_across_pairwise_key_reinstall() {
    ...
    assert_eq!(
        ...
        Err(ApSecurityError::Replay(CcmpReplayError::Replayed {
            packet_number: pn4,
            highest: pn4,
        })),
