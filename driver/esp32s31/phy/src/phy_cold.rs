...
//!
//! The initial image below is the complete 508-byte `.data.phy_param` section
//! from the qualified `libphy.a` artifact.
...
use crate::{
    ...
    phy_param::{
        ...
        PHY_PARAM_LEN, apply_init_data, apply_rc_calibration_result,
        calibration_record_check_or_write, xtal_parameter_code,
    },
    ...
    >(
        ...
        match self.outer_action {
            PhyRfInitPrefixAction::ConfigureFeBbClock => {
                ...
                open_esp_radio_esp32s31_hal::analog_i2c::enable_frontend_baseband_power(platform);
...
impl PhyColdObservationBinding {
    ...
    #[cfg(target_arch = "riscv32")]
    pub fn execute_target<P: open_esp_radio_esp32s31_hal::analog_i2c::PhyPmuControl>(
        self,
        radio: &mut open_esp_radio_esp32s31_hal::Radio<
            P,
            open_esp_radio_esp32s31_hal::state::Powered,
...
mod tests {
    use super::{
        PHY_COLD_PARAMETER_LEN, PhyCalibrationRecord, PhyColdExternalBinding, PhyColdI2cAction,
