...
use {
    crate::{
        ...
        le::dtm::{
            ...
            DtmSchedulerItemEventError, DtmTransmitterEvent, DtmTxSchedulerTiming,
            DtmTxTimingMicros,
        },
    },
    oer_esp32s31_bluetooth::interrupt::SchedulerWakeBatch,
};
#[cfg(any(target_arch = "riscv32", test))]
use {
    crate::{
...
use {
    crate::le::dtm::DtmRole,
    oer_esp32s31_bluetooth::runtime_resources::ControllerPoweredTaskRuntime,
};
...
pub(crate) trait DtmScheduling<const SCHEDULER_CAPACITY: usize> {
    ...
    fn step_dtm_stop<Role>(
        &mut self,
        storage: &impl oer_esp32s31_bluetooth::scheduler::SchedulerRunInterruptStorage,
        running: DtmSchedulerRunning<Role>,
        stop: oer_esp32s31_hal::bluetooth::BluetoothSchedulerStop,
    ...
    for ControllerPoweredTaskRuntime<'_, SCHEDULER_CAPACITY>
{
    ...
    fn observe_dtm_completion<Role>(
        ...
        let oer_esp32s31_bluetooth::scheduler::SchedulerFinishedListWorkerStep::List {
            observed,
            more,
        } = step
        else {
