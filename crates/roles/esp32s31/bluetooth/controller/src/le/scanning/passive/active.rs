...
type RemovalReady =
    oer_esp32s31_bluetooth::scheduler::core::SingleItemSchedulerSoftwareListRemovalReady<
        PassiveScanCompletionRole,
    >;
...
impl oer_esp32s31_bluetooth::scheduler::core::SingleItemSchedulerRole
    for PassiveScanCompletionRole
{
    ...
    fn observe_completion(
        ...
        match item.observe_completion(observed) {
            ...
            oer_esp32s31_bluetooth_memory::PassiveScanMemoryGraphCompletionObservation::StillInFlight(running) => {
                oer_esp32s31_bluetooth::scheduler::core::SingleItemRoleCompletionObservation::StillInFlight(running)
            }
            oer_esp32s31_bluetooth_memory::PassiveScanMemoryGraphCompletionObservation::CompletionObserved(completed) => {
                oer_esp32s31_bluetooth::scheduler::core::SingleItemRoleCompletionObservation::CompletionObserved(completed)
            }
        }
    }
