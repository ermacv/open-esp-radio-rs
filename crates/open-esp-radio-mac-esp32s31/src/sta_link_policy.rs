...
use open_esp_radio_ieee80211::{
    he::{
        parse_he20_capabilities, parse_he20_operation, parse_he20_peer_state, He20Capabilities,
        He20PeerState, HeDcmConstellation, HeElementError, HeMcsNssSupport,
    },
    scan::ScanRecord,
...
impl StaPeerScanPolicy {
    pub fn new(access_point: &ScanRecord) -> Result<Self, EdcaParametersError> {
        ...
        // `_oracles/libpp.a[trc.o]::rcUpdateAMPDUParam`.
    ...
    pub fn complete(
        ...
        // `ic_set_trc`. Complete `_oracles/libpp.a[if_hwctrl.o]::ic_set_trc`
        ...
        // to `ic_set_trc`; complete `_oracles/libpp.a[trc.o]::
