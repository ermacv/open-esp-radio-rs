...
Projects require metadata schema 19 and journal schema 20; earlier/future formats
...
Run schema 20 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 19.
