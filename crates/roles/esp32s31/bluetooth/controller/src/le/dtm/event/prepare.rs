...
use {
    crate::{
        DtmLinkStateReset, DtmRxInitialEventWindow, DtmRxRecurringEventWindow,
        DtmSchedulerReservation, DtmTxEventWindow,
        le::dtm::{
    ...
    oer_esp32s31_bluetooth::scheduler::SchedulerSequenceReady,
};
...
impl<Role> DtmCompletionObservedEvent<Role> {
    ...
    pub(crate) fn recycle<const CAPACITY: usize>(
        self,
        timeline: &mut oer_esp32s31_bluetooth::scheduler::timeline::SchedulerTimeline<CAPACITY>,
