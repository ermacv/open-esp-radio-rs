...
use crate::{
    rate::control::dot11g_schedule_for_legacy_rate,
    rate::low::{MacLowRateGateProbe, MacLowRateTransitionError, probe_phy_low_rate_gate},
    rate::schedule::{
...
impl TxPhyRate {
    ...
    pub fn from_rate_control_schedule(
        ...
        let code = crate::rate::schedule::schedule_state(schedule).rate;
