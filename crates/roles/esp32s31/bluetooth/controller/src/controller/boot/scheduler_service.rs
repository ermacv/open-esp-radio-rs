    ...
    ControllerPublishedTaskService<'runtime, S, SCHEDULER_CAPACITY>
{
    ...
    pub const fn scheduler_wake(&self) -> &oer_esp32s31_bluetooth::interrupt::SchedulerWakeCell {
    ...
    pub const fn scheduler_lock_modify_events(
        &self,
    ) -> &oer_esp32s31_bluetooth::scheduler::SchedulerLockModifyEventCell {
    ...
    pub fn scheduler_finished_lists(
        &mut self,
    ) -> &mut oer_esp32s31_bluetooth::scheduler::SchedulerFinishedListWorker {
    ...
    pub(crate) const fn legacy_connectable_advertising_scheduler_config(
        &self,
    ) -> oer_esp32s31_bluetooth::scheduler::SchedulerSoftwareConfig {
    ...
    pub fn step_scheduler_lock_modify(
        &mut self,
        event: oer_esp32s31_bluetooth::scheduler::SchedulerLockModifyEvent,
    ) -> oer_esp32s31_bluetooth::scheduler::SchedulerLockModifyWorkerStep {
    ...
    pub(crate) fn start_legacy_advertising_scheduler<'a>(
        ...
        oer_esp32s31_bluetooth::scheduler::core::SingleItemSchedulerRunning<
        ...
        S: SchedulerRunInterruptStorage,
    {
        ...
        Ok(
            oer_esp32s31_bluetooth::scheduler::core::SingleItemSchedulerRunning::new(
                item,
                run,
                reservation,
            ),
    ...
    pub(crate) fn recycle_legacy_advertising_completed<'a>(
        &mut self,
        ready: oer_esp32s31_bluetooth::scheduler::core::SingleItemSchedulerSoftwareListRemovalReady<
            crate::le::advertising::legacy::completion::LegacyAdvertisingCompletionRole<'a>,
        >,
