...
## Bootstrap\n\n\
```console\n\
cargo blobray project inputs init --project vendor-project.toml \\\n{bindings}\n\
cargo blobray project doctor --project vendor-project.toml\n\
cargo blobray project configure --project vendor-project.toml --check\n\
cargo blobray project status --project vendor-project.toml\n\
cargo blobray advanced symbols inventory --project vendor-project.toml\n\
cargo blobray advanced code init-pack --project vendor-project.toml\n\
cargo blobray advanced interfaces discover --project vendor-project.toml\n\
cargo blobray advanced interfaces init-pack --project vendor-project.toml\n\
cargo blobray advanced ir build --project vendor-project.toml\n\
cargo blobray advanced functions init-pack --project vendor-project.toml\n\
