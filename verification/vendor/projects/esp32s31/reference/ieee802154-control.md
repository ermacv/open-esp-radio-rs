# ESP32-S31 IEEE 802.15.4 control-state contracts
...
Hashes identify the complete pinned public files.
...
| [`components/ieee802154/crates/esp_ieee802154_dev.c`](https://github.com/espressif/esp-idf/blob/7b9cc1ac79f865983f59bb8ff3ff43eb74ff1dbe/components/ieee802154/crates/esp_ieee802154_dev.c#L78-L165) | deferred-next flag and timer-zero callback | `9aaccfa2832cb89bfdfd98086a984269e621400a272b02926c4e088d16222830` |
| [`components/ieee802154/crates/esp_ieee802154_dev.c`](https://github.com/espressif/esp-idf/blob/7b9cc1ac79f865983f59bb8ff3ff43eb74ff1dbe/components/ieee802154/crates/esp_ieee802154_dev.c#L314-L505) | state-specific stop and next-operation paths | same file/hash as above |
| [`components/ieee802154/crates/esp_ieee802154_dev.c`](https://github.com/espressif/esp-idf/blob/7b9cc1ac79f865983f59bb8ff3ff43eb74ff1dbe/components/ieee802154/crates/esp_ieee802154_dev.c#L507-L769) | event-handler state changes and terminal effects | same file/hash as above |
| [`components/ieee802154/crates/esp_ieee802154_dev.c`](https://github.com/espressif/esp-idf/blob/7b9cc1ac79f865983f59bb8ff3ff43eb74ff1dbe/components/ieee802154/crates/esp_ieee802154_dev.c#L782-L895) | snapshot, acknowledgement, assertions, and ordered dispatch | same file/hash as above |
| [`components/ieee802154/crates/esp_ieee802154_dev.c`](https://github.com/espressif/esp-idf/blob/7b9cc1ac79f865983f59bb8ff3ff43eb74ff1dbe/components/ieee802154/crates/esp_ieee802154_dev.c#L985-L1131) | operation-start order and timed receive callbacks | same file/hash as above |
| [`components/ieee802154/crates/esp_ieee802154_dev.c`](https://github.com/espressif/esp-idf/blob/7b9cc1ac79f865983f59bb8ff3ff43eb74ff1dbe/components/ieee802154/crates/esp_ieee802154_dev.c#L1193-L1252) | RF client guard, sleep, ED, and CCA entry | same file/hash as above |
| [`components/ieee802154/crates/esp_ieee802154_timer.c`](https://github.com/espressif/esp-idf/blob/7b9cc1ac79f865983f59bb8ff3ff43eb74ff1dbe/components/ieee802154/crates/esp_ieee802154_timer.c#L13-L125) | timer callback storage, clearing, and invocation | `66a2b68bb718d8fa878cbf28488af810ecb902288fde26dc7a0e5b32dcbd1326` |
...
`TX_CCA` immediately after issuing the corresponding command. This reference does
...
assigns this register W1C semantics. The generated PAC mirrors the source
...
The reviewed target fact assigns W1C, the SVD publishes `oneToClear`, and the PAC
