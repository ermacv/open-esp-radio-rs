//! Architecture-neutral semantic qualification interfaces.
//!
//! The validator facade dispatches these requests to an explicitly selected
...
pub struct DriverAdapterQualification {
    pub matched: bool,
