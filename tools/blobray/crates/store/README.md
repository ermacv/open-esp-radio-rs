...
Projects require metadata schema 11 and journal schema 12; earlier/future formats
...
Run schema 12 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 11.
