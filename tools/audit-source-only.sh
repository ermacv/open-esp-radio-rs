...
if rg -n \
    'configure_phy_register_force_txrx|sample_phy_i2c_master_reset|pulse_phy_i2c_master_reset|phy_i2c_master_reset_busy|configure_phy_register_xtal_frequency|read_phy_sdm_cycle_counter' \
    crates/open-esp-radio-phy-esp32s31/src
then
