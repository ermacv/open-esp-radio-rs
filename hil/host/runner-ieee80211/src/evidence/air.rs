...
pub struct AirFrame {
    ...
    /// The capture's A-MPDU reference: MPDUs of one A-MPDU share it.
...
fn frame(fields: &[&str]) -> Result<AirFrame> {
    ...
    Ok(AirFrame {
        ...
        ampdu_reference: optional(fields[17])?,
        erp_information: optional(fields[18])?,
        ht_protection: optional(fields[19])?,
        payload: fields
            .get(20)
