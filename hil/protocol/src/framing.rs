...
mod tests {
    ...
    use crate::{
        ...
        Ieee802154EventStatusProbeStop, Ieee802154ObservedEventState, Ieee802154PolledEdOutcome,
        Ieee802154RxAbortObservation, Ieee802154ValidationEdDurationState,
        Ieee802154ValidationEventEnableState, Ieee802154ValidationRxAbortEnableState, Ipv4Endpoint,
        SessionConfig, SessionLinkRequirements, StackUsage, StackWatermark, StartupArtifactChunk,
    ...
    fn maximum_wifi_egress_policy_evidence_fits_and_round_trips() {
        ...
        let expected = Envelope::new(
            ...
            Event::Evidence(EvidenceRecord::WifiEgressPolicy(WifiEgressPolicyEvidence {
                ...
                grants_used: u32::MAX,
                grants_unused: u32::MAX,
                progress_without_grant: u32::MAX,
                rejected_updates: u32::MAX,
                rejected_progress: u32::MAX,
                station: vif,
                access_point: vif,
            })),
        );
