...
1. finish restricted PAC access for the remaining scheduler command/status
   ...
   a pre-arm event from entering the DTM gate. Command-ready interrupt causality
   remains unproven, but the absolute direct recheck closes DTM retry liveness
   after mailbox-full delivery. Live handler
