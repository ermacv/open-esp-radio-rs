...
impl WatchdogConfig {
    ...
    /// Automatic maintenance includes IRQ/timer quiescence and full restoration.
    /// Manual maintenance starts from an already retired idle timer/IRQ owner;
    /// the preceding synchronous retirement does not execute PHY work.
    /// Shutdown covers
