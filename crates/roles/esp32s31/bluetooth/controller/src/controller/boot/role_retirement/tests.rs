...
use std::boxed::Box;
use {
    crate::le::{advertising::*, dtm::*, peripheral::*, scanning::*},
    oer_esp32s31_bluetooth::resources::runtime_owner::RuntimeOwnerSlot,
};
...
fn rejected(
    lease: &mut oer_esp32s31_bluetooth::resources::runtime_owner::RuntimeOwnerLease<
        '_,
        ControllerRoleResources,
    >,
