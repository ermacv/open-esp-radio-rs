...
pub const TX_FRAME_NEXT_OFFSET: usize = 0x30;
pub const TXOP_CLASS_COUNT: usize = 3;
...
pub const fn select_ready_logical_queue(
    hardware_queue: u8,
    allowed_mask: u16,
    cursor: u8,
    ready_mask: u16,
...
#[cfg(test)]
mod tests {
    use super::{select_ready_logical_queue, LogicalQueue, TxopQueueState, TX_FRAME_NEXT_OFFSET};
