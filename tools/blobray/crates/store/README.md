...
Projects require metadata schema 22 and journal schema 23; earlier/future formats
...
Run schema 23 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 22.
