    ...
    BluetoothControllerPublishedTaskService<'runtime, S, SCHEDULER_CAPACITY>
{
    ...
    pub(crate) fn prepare_legacy_connectable_advertising_recurring_event(
        ...
        crate::scheduler::core::BluetoothLegacyConnectableAdvertisingEventPrepared,
        crate::scheduler::core::BluetoothLegacyConnectableAdvertisingEventPreparationFailure,
    > {
        self.runtime.prepare_legacy_connectable_advertising_event(
            admitted,
            crate::scheduler::core::BluetoothLegacyConnectableAdvertisingSequenceObservation {
                sample,
            },
        )
    }
    ...
    pub(crate) fn merge_legacy_connectable_advertising_recurring_event(
        ...
        crate::scheduler::core::BluetoothLegacyConnectableAdvertisingEmptySchedulerMergePrepared,
        crate::scheduler::core::BluetoothLegacyConnectableAdvertisingEmptySchedulerMergeFailure,
    > {
        self.runtime
        ...
        S: BluetoothSchedulerRunInterruptStorage,
    {
        ...
        Ok(
            crate::scheduler::core::BluetoothSingleItemSchedulerRunning::new(
                item,
                run,
                reservation,
            ),
