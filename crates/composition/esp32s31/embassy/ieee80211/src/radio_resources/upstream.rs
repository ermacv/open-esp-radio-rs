...
use oer_xarxa_upstream::{Device, Resources};
...
type Endpoint = oer_xarxa_upstream::Endpoint<'static, CriticalSectionRawMutex, RX_DEPTH, TX_DEPTH>;
...
pub(crate) fn initialize_network(
    ...
    (
        WifiDevices {
            station: WifiDevice { inner: station },
