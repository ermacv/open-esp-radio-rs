...
2. Port the blob's exact rate/GI/profile HE APEP-duration table, then qualify
   DCM MCS1/QPSK and MCS3/16-QAM against a peer that advertises them. Wire the
