...
Projects require metadata schema 30 and journal schema 31; earlier/future formats
...
Run schema 31 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 30.
