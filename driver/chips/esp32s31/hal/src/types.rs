...
pub use open_esp_radio_esp32s31_pac::{
    ...
    MacHeTxVectorSnapshot, MacHtAmpduCompletionRegisters, MacHtTxProgram, MacInterface,
    MacInterruptEvents, MacInterruptMask, MacInterruptSnapshot, MacItwtClearIndex,
    MacKeyEntryIndex, MacKeyInstallOutcome, MacLegacyTxProgram, MacPartialRuPowerSelector,
