...
pub struct PassiveScanFirstEventCandidate {
    ...
    requested_window: oer_esp32s31_bluetooth::scheduler::SchedulerRawWindow,
...
impl PassiveScanFirstEventCandidate {
    ...
    pub const fn requested_window(&self) -> oer_esp32s31_bluetooth::scheduler::SchedulerRawWindow {
    ...
    fn prepare_resolved_event(
        self,
        resolved_window: oer_esp32s31_bluetooth::scheduler::SchedulerRawWindow,
