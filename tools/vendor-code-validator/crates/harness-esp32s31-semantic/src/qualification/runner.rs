...
pub fn qualify_esp32s31_channel(
    svd: &MmioRegisterMap,
...
pub fn qualify_esp32s31_rf_init(
    svd: &MmioRegisterMap,
    vendor_artifact: &Path,
    vendor_companion: &Path,
    print_oracles: bool,
...
pub fn qualify_esp32s31_bluetooth_txdc(
    svd: &MmioRegisterMap,
    vendor_artifact: &Path,
    vendor_companion: &Path,
    print_oracles: bool,
...
pub fn qualify_esp32s31_bluetooth_tx_power(
    svd: &MmioRegisterMap,
    vendor_artifact: &Path,
    vendor_companion: &Path,
    print_oracles: bool,
...
pub fn qualify_esp32s31_bluetooth_txdc_pwdet(
    svd: &MmioRegisterMap,
    vendor_artifact: &Path,
    vendor_companion: &Path,
    print_oracles: bool,
