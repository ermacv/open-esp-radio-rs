//! Concrete ESP32-S31 ports for the WPA2 four-way handshake.
//!
//! The chip-independent runners in [`crate::wpa2`] own replay protection,
//! cryptography, deadlines and rollback order. This module binds those
//! transactions to the retained ESP32-S31 RX frontier, ordinary control TX
//! descriptor and hardware CCMP slots without importing a board fixture.
...
use open_esp_radio_esp32s31_wifi_mac::{
    ...
    tx::{LegacyRate, LegacyTxQueue, TxCompletion, TxHardware, TxPhyRate},
};
use open_esp_radio_ieee80211::station::{
    StaDataFrame, StaProtectedDataFrame, StaTxSequenceCounters,
};
use open_esp_radio_wpa2::{
    OwnedEapolFrame, Wpa2Interface, frames::Wpa2TxFrame, keys::Wpa2KeyKind,
...
use crate::{
    ...
    wpa2::{Wpa2HandshakeBackend, Wpa2KeyInstallBackend, Wpa2RxProgress},
};
...
fn copy_station_eapol(
    frame: &[u8],
    mpdu_length: usize,
    payload_offset: usize,
    station: Esp32s31Wpa2Station,
) -> Option<OwnedEapolFrame<EAPOL_CAPACITY>> {
    if mpdu_length < 24
