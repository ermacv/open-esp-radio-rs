...
mod tests {
    ...
    fn waiting_then_ready_preserves_controller_and_phase_identity() {
        ...
        let pending =
            BluetoothTimedPreparationPending::begin(controller, Phase("admission"), rollback)
    ...
    fn failed_recheck_rolls_back_the_exact_phase_before_fail_stop() {
        ...
        let pending =
            BluetoothTimedPreparationPending::begin(controller, Phase("sequence"), rollback)
                .expect("the request begins");
    ...
    fn cancellation_waits_for_exact_orphan_drain_before_recovery() {
        ...
        let pending =
            BluetoothTimedPreparationPending::begin(controller, Phase("timing"), rollback)
                .expect("the request begins");
