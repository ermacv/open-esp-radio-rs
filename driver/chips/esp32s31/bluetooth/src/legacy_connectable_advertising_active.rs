...
pub(crate) use crate::connectable_advertising::BluetoothLegacyConnectableAdvertisingPeripheralResetEvidence;
...
enum BluetoothLegacyConnectableAdvertisingActiveFailStopOwner {
    ...
    NoConnectionRestore {
        _outcome: crate::connectable_advertising::BluetoothLegacyConnectableAdvertisingNoConnection,
    },
    ConnectionRestore {
        _outcome:
