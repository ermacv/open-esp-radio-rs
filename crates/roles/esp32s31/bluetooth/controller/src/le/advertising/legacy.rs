...
#[cfg(any(target_arch = "riscv32", test))]
use {
    crate::{LegacyAdvertisingEventWindow, le::advertising::LegacyAdvertisingTimingObservation},
    oer_esp32s31_bluetooth::scheduler::{SchedulerRawWindow, SchedulerSoftwareConfig},
};
