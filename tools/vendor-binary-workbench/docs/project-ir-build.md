...
The schema-v50 random-access bundle stores pseudo-Rust with each function.
...
Artifact identities and digests remain embedded in the schema-v50 report, so a
...
generated linked-IR bundle remains a separate schema-v50 project artifact; the
...
valid schema-v50 output. It also reports whether the bundle is linked into
