...
pub use super::hci_order::{
    LegacyConnectablePeripheralFirstHciAxis, LegacyConnectablePeripheralFirstHciResponseWait,
};
use super::hci_order::{
    LegacyConnectablePeripheralFirstHciOrder, LegacyConnectablePeripheralFirstHciOrderPublication,
};
