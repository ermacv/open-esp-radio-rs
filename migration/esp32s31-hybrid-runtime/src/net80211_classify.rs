...
pub(crate) const ETHER_TYPE_IPV4: u16 = 0x0008;
pub(crate) const ETHER_TYPE_ARP: u16 = 0x0608;
pub(crate) const ETHER_TYPE_EAPOL: u16 = 0x8e88;
pub(crate) const ETHER_TYPE_WAPI: u16 = 0xb488;
pub(crate) const ETHER_TYPE_IPV6: u16 = 0xdd86;
pub(crate) const ETHER_TYPE_VENDOR_PRIORITY: u16 = 0xeeee;

pub(crate) const fn uses_fixed_per_packet_rate(
    protocol: u16,
    sta_arp: bool,
...
pub(crate) const fn user_priority(
    protocol: u16,
    ipv4_tos: Option<u8>,
    ipv6_prefix: Option<u32>,
) -> u32 {
    match protocol {
...
pub(crate) const fn apply_wmm_admission(mut priority: u32, admission_required: [bool; 3]) -> u32 {
