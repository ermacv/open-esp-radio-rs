...
//!
//! Protocol parsing/state live in `open-esp-radio-ieee80211`. This module owns
//! the ordering and absolute deadlines of finite hardware transactions while
//! receiving time through an explicit port.
