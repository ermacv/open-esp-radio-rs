...
Projects require metadata schema 13 and journal schema 14; earlier/future formats
...
Run schema 14 carries the admitted operation, optional concrete scenario
...
Function manifests accept version 6 with typed source, address space, declared
...
The analyses table and publication transaction remain metadata schema 13.
...
Concrete execution manifests and JSONL evidence use CAS payloads. Schema-7
execution runs in the existing database carry their publication reference;
