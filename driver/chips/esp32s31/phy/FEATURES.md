...
[Wi-Fi](../ieee80211/FEATURES.md), [Bluetooth](../bluetooth/FEATURES.md) and
[IEEE 802.15.4](../ieee802154/FEATURES.md) inventories. CSI capture, CTE IQ
sample delivery and protocol antenna-selection policy remain there.
[Coexistence](../coex/FEATURES.md) owns shared-RF arbitration coverage.
...
| Periodic tracking service | PARTIAL | [Client state](src/state/client.rs) evaluates tracking deadlines and target runners can execute requests. Complete long-running scheduling, cancellation and teardown are not composed for every protocol. |
...
The relevant callers are [Wi-Fi cold start](../ieee80211/src/cold_start.rs),
[Bluetooth PHY setup](../bluetooth/src/phy.rs),
