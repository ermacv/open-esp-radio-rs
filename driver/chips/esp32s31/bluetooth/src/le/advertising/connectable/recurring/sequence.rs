...
use crate::{
    ...
    le::advertising::connectable::active::BluetoothLegacyConnectableAdvertisingAwaitingRecurrence,
...
pub(crate) struct BluetoothLegacyConnectableAdvertisingRecurrenceTimedController<
    'runtime,
    S,
    ...
    S: BluetoothSchedulerRunInterruptStorage,
{
    ...
    pub(crate) rollback: Option<BluetoothLegacyConnectableAdvertisingRollbackFailure>,
}
...
pub(crate) struct BluetoothLegacyConnectableAdvertisingRecurrenceRollbackFailed;

#[derive(Clone, Copy)]
pub(crate) struct BluetoothLegacyConnectableAdvertisingRecurrenceContext {
...
impl BluetoothLegacyConnectableAdvertisingRecurrenceContext {
    fn from_completed(
        completed: &crate::le::advertising::connectable::BluetoothLegacyConnectableAdvertisingNoConnectionRestored,
    ) -> Self {
        Self {
...
pub(crate) enum BluetoothLegacyConnectableAdvertisingRecurringFailStopOwner<
    'runtime,
    S,
    const CAPACITY: usize,
> where
...
> where
    S: BluetoothSchedulerRunInterruptStorage,
{
    pub(crate) cause: BluetoothLegacyConnectableAdvertisingRecurringFailStopCause,
    pub(crate) context: BluetoothLegacyConnectableAdvertisingRecurrenceContext,
    pub(crate) _owner:
