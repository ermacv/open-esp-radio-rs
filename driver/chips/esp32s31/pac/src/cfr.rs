...
impl RadioPhyRegisters {
    ...
    pub fn configure_hccfr_from_vendor_arguments(&mut self, enabled: u32, value: u32) {
        let bb = &self.peripherals.phy_baseband_config_oracle;
        super::generated::configure_hccfr_enable_from_vendor_argument(
            bb,
            vendor_register_argument(enabled),
        );
        super::generated::configure_hccfr_value_from_vendor_argument(
            bb,
    ...
    pub fn configure_forced_iccfr_from_vendor_arguments(
        ...
        super::generated::trigger_forced_iccfr(bb);
        super::generated::configure_forced_iccfr_mode_low(bb, mode);
        super::generated::configure_forced_iccfr_value_from_vendor_argument(
            bb,
            vendor_register_argument(value),
        );
        self.configure_iccfr_gate(enabled);
