...
#[derive(Clone, Copy, Debug, Eq, PartialEq)]
pub struct DtmTxSchedulerTiming {
    interval_micros: u32,
    packet_window_micros: u32,
    remainder_micros: u8,
}

impl DtmTxTimingMicros {
    ...
    pub const fn new(
        ...
        let (micros_per_octet, header_micros) = match phy {
            DtmPhy::Le1M => (8, 80),
            DtmPhy::Le2M => (4, 44),
            DtmPhy::LeCoded => (64, 720),
            DtmPhy::LeCodedS2 => (16, 462),
        };
        let packet_duration =
    ...
    /// interval.
    pub const fn scheduler_timing(self) -> DtmTxSchedulerTiming {
