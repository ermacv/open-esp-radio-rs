...
pub enum LegacyConnectablePeripheralFirstRunningWait<'a> {
    Scheduler(&'a oer_esp32s31_bluetooth::interrupt::SchedulerWakeCell),
    ...
    S: SchedulerRunInterruptStorage,
{
    ...
    where
        ...
        Unrelated: FnOnce(
            Context,
            Self,
            oer_esp32s31_bluetooth::scheduler::BluetoothSchedulerFinishedHardwareListObserved,
        ) -> R,
...
pub enum LegacyConnectablePeripheralFirstFailStopCause {
    ...
    PreparationControllerTime(oer_esp32s31_bluetooth::scheduler::ControllerTimeAcquisitionError),
