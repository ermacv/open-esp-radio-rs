...
#[cfg(any(target_arch = "riscv32", test))]
use crate::scheduler::core::BluetoothSchedulerExclusiveListEpoch;
#[cfg(any(target_arch = "riscv32", test))]
...
pub struct BluetoothControllerPoweredTaskRuntime<'runtime, const SCHEDULER_CAPACITY: usize = 4> {
    ...
    pub(crate) _standalone_dtm_profile:
        &'runtime crate::controller::hal::BluetoothStandaloneAlwaysAwakeDtmProfile,
    ...
    BluetoothControllerPoweredTaskRuntime<'_, SCHEDULER_CAPACITY>
{
    pub(crate) const fn new<'runtime>(
        ...
        standalone_dtm_profile: &'runtime crate::controller::hal::BluetoothStandaloneAlwaysAwakeDtmProfile,
