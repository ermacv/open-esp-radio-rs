...
use crate::low_power::ControllerLowPowerHardwareInitialized;
...
pub struct PhyInitializationReport {
...
/// acquisition.
///
/// The lower owner retains both [`oer_esp32s31_phy::RegisteredPhyState`]
