//! Qualification of the Rust RX-ring transaction replacing
//! `wDev_AppendRxBlocks`.
//!
...
pub fn qualify_esp32s31_wdev_append_rx_blocks(
    svd: &MmioRegisterMap,
    ...
    let vendor_inventory = vendor_inventory
        .ok_or("wDev_AppendRxBlocks qualification requires the caller-owned raw libpp inventory")?;
    if print_oracles {
