...
> Historical migration snapshot. This document records the incremental
> PAC/MMIO transfer through 2026-07-27. It is not the current unsafe inventory;
> see [`../../PAC_AND_UNSAFE_AUDIT.md`](../../PAC_AND_UNSAFE_AUDIT.md).
