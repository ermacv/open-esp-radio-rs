...
The schema-v53 random-access bundle stores pseudo-Rust with each function.
...
Artifact identities and digests remain embedded in the schema-v53 report, so a
...
generated linked-IR bundle remains a separate schema-v53 project artifact; the
...
valid schema-v53 output. It also reports whether the bundle is linked into
