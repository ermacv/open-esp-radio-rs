...
use oer_xarxa_upstream::{Endpoint, LinkController, RxPublisher, TxFrame};
...
impl<M: RawMutex, const RX: usize, const TX: usize> DatapathNetworkRx for Rx<'_, M, RX, TX> {
    fn pool_exhaustion(
        &self,
    ) -> oer_esp32s31_ieee80211_runtime::datapath::network::RxPoolExhaustion {
        oer_esp32s31_ieee80211_runtime::datapath::network::RxPoolExhaustion::DropFrame
    }
