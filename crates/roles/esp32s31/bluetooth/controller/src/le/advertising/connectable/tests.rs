    ...
    let candidate = prepared
        .form_first_event_candidate(
            crate::le::advertising::LegacyAdvertisingTimingObservation {
                current: oer_esp32s31_bluetooth::SchedulerInstant::from_image(30_000),
                radio_ready: oer_esp32s31_bluetooth::SchedulerInstant::from_image(32_000),
                epoch,
            },
...
fn no_connection_restore_returns_both_runtime_slots_atomically() {
    ...
    let candidate = prepared
        .form_first_event_candidate(
            crate::le::advertising::LegacyAdvertisingTimingObservation {
                current: oer_esp32s31_bluetooth::SchedulerInstant::from_image(10_000),
                radio_ready: oer_esp32s31_bluetooth::SchedulerInstant::from_image(12_000),
                epoch,
            },
            SchedulerSoftwareConfig::reviewed_standalone(),
        )
...
fn foreign_no_connection_restore_preserves_the_exact_role_owner() {
    ...
    let candidate = prepared
        .form_first_event_candidate(
            crate::le::advertising::LegacyAdvertisingTimingObservation {
                current: oer_esp32s31_bluetooth::SchedulerInstant::from_image(20_000),
                radio_ready: oer_esp32s31_bluetooth::SchedulerInstant::from_image(22_000),
                epoch,
            },
            SchedulerSoftwareConfig::reviewed_standalone(),
        )
