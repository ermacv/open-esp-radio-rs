...
use open_esp_radio_bluetooth_ll::connectable_advertising::LegacyConnectableAdvertiserStandby;
...
#[cfg(any(target_arch = "riscv32", test))]
use open_esp_radio_esp32s31_bluetooth_memory::{
    BLUETOOTH_NON_SCANNING_RX_NODE_COUNT, BluetoothLeReceivedPdu,
...
#[cfg(target_arch = "riscv32")]
use open_esp_radio_esp32s31_bluetooth_memory::{
    BluetoothLeReceivedBatch, BluetoothLegacyConnectableAdvertisingMemoryGraphCompletionObserved,
...
use crate::BluetoothLegacyAdvertisingDefaultTxPowerDbm;
#[cfg(any(target_arch = "riscv32", test))]
use crate::{
    ...
    BluetoothLegacyAdvertisingTimingObservation, BluetoothPeripheralConnectionRuntimeBeginError,
    BluetoothPeripheralConnectionRuntimeResources, BluetoothSchedulerRawWindow,
