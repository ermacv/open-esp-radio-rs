...
```console
cargo vendor-binary-workbench registers review --project path/to/vendor-project.toml
cargo vendor-binary-workbench registers validate --project path/to/vendor-project.toml
...
PAC generation remains a core Workbench responsibility:
