    ...
    oer_esp32s31_bluetooth_controller::{
        ...
        le::{
            advertising::{
                ...
                LegacyAdvertisingCpuOwnedResponsePublication,
                ...
                LegacyConnectableAdvertisingCommandMismatch,
                ...
                LegacyConnectableAdvertisingHciActiveStep,
                LegacyConnectableAdvertisingResponsePending,
                LegacyConnectableAdvertisingResponsePublication,
                LegacyConnectableAdvertisingStopping, LegacyConnectableAdvertisingStoppingFailStop,
                LegacyConnectableAdvertisingStoppingStep,
            },
            dtm::{
                ControllerIdleCommandMismatch, ControllerIdleCommandRoute,
                DtmActiveCommandMismatch, DtmActiveSessionFault, DtmFirstPreparationCleanup,
                DtmFirstPreparationCleanupStep, DtmFirstPreparationCompletion,
                DtmFirstPreparationFailStop, DtmFirstRunnerFailure, DtmFirstRunnerRetry,
                DtmOrderReady, DtmResetCompletionReady, DtmResetCompletionStart,
            ...
            peripheral::{
                LegacyConnectablePeripheralFirstHciAxis,
                LegacyConnectablePeripheralFirstHciFailStop,
                ...
                PeripheralConnectionCommandIntake, PeripheralConnectionCommandMismatch,
                PeripheralConnectionCommandRoute, PeripheralConnectionHostEventPublication,
                PeripheralConnectionResetBarrier, PeripheralConnectionResetFault,
                PeripheralConnectionResetStep,
            },
            scanning::{
                ...
                PassiveScanHciRecurringRunner, PassiveScanHciReportStep,
                PassiveScanHciReportsComplete, PassiveScanHciReportsPending,
                PassiveScanHciResponsePendingSession, PassiveScanHciResponsePublication,
                PassiveScanHciStopping, PassiveScanHciStoppingFault, PassiveScanHciStoppingStep,
            },
        },
    },
};
