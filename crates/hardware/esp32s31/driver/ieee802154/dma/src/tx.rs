...
///
/// ```compile_fail
/// use oer_esp32s31_ieee802154_dma::TxBindFailure;
///
...
impl TxStorage {
    ...
    ///
    /// ```compile_fail
    /// use oer_esp32s31_ieee802154_dma::{DMA_LOW, TxStorage};
    ///
...
impl PinnedTxBuffer {
    ...
    ///
    /// ```compile_fail
    /// use oer_esp32s31_ieee802154_dma::{DmaFrameAddress, PinnedTxBuffer, TxStorage};
    ///
    /// let storage = Box::leak(Box::new(TxStorage::new()));
