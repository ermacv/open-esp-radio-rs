...
pub(crate) struct ForbiddenTargetRange {
...
pub(crate) struct ForbiddenDirectTarget {
...
pub(crate) struct DirectTargetAudit {
    pub(crate) executable_sections: usize,
    pub(crate) executable_bytes: usize,
    pub(crate) decoded_instructions: usize,
    pub(crate) unsupported_instructions: usize,
    pub(crate) forbidden_targets: Vec<ForbiddenDirectTarget>,
}
...
pub(crate) fn audit_direct_targets(
    artifact_path: &Path,
    ranges: &[ForbiddenTargetRange],
