...
> {
    ...
    roles: crate::resources::runtime_owner::RuntimeOwnerSlot<
...
> {
    ...
    pub(crate) platform:
        crate::resources::platform_retirement::ControllerPlatformLease<'runtime, P>,
    ...
    M: RawMutex,
{
    ...
    Ready(
        ControllerPublishedRuntimeEndpoints<
            ...
            PACKET_CAPACITY,
        >,
        crate::resources::platform_retirement::ControllerRuntimePlatform<'runtime, P>,
    ),
    ...
    S: ModemLpTimerSoftwareOwnerStorage,
{
    ...
    > {
        ...
        roles.as_mut()?;
        let crate::ble_phy::BlePhyRuntime {
            endpoints:
        ...
        S: InterruptOwnerStorage,
    {
        ...
        match storage.publish(interrupts, timer) {
            Ok(published) => Ok(ControllerInterruptOwnersPublished {
                ...
                roles: crate::resources::runtime_owner::RuntimeOwnerSlot::new(
                    super::role_retirement::ControllerRoleResources {
                        dtm_resources,
...
impl<P, const MT: usize, const SC: usize> ControllerInterruptOwnersReady<P, MT, SC> {
    ...
    pub(super) fn restore_interrupt_owners<S: InterruptOwnerRestartStorage>(
        self,
        storage: &S,
    ) -> Result<crate::ble_phy::BlePhyRestartParts<P, MT, SC>, (S::RestartError, Self)> {
