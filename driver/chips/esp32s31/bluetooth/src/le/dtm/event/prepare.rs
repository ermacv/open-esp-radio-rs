...
use crate::{
    ...
    BluetoothSchedulerSequenceReady, le::dtm::rx::BluetoothDtmReceiverSession,
    le::dtm::scheduler::item::apply_overlap_insertion_power,
};
...
impl<Role> BluetoothDtmCompletionObservedEvent<Role> {
    ...
    pub(crate) fn recycle<const CAPACITY: usize>(
        self,
        timeline: &mut crate::scheduler::timeline::BluetoothSchedulerTimeline<CAPACITY>,
