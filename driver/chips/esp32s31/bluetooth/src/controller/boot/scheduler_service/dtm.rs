    ...
    pub fn unlink_and_arm_dtm_software_list_removal<Role>(
        ...
        critical_section::with(|critical_section| {
            ...
            match runtime.unlink_dtm_software_list(observed) {
                crate::scheduler::core::BluetoothDtmSchedulerSoftwareListUnlinkStep::SchedulerIdentityMismatch(
                    observed,
                ) => BluetoothDtmPostUnlinkArmStep::SchedulerIdentityMismatch(observed),
                crate::scheduler::core::BluetoothDtmSchedulerSoftwareListUnlinkStep::Unlinked(
                    unlinked,
                ) => {
            ...
            let (key, pending) = match mailbox.take(critical_section, awaiting) {
                BluetoothPostUnlinkTake::Recheck { key, unlinked } => {
                    return match runtime.recheck_dtm_software_list_removal(storage, unlinked) {
                        crate::scheduler::core::BluetoothDtmSchedulerSoftwareListRemovalRecheck::SchedulerIdentityMismatch(
                            unlinked,
                        ) => BluetoothDtmSoftwareListRemovalPublishedStep::DirectSchedulerIdentityMismatch {
                            unlinked,
                        },
                        crate::scheduler::core::BluetoothDtmSchedulerSoftwareListRemovalRecheck::StorageUnavailable(
                            unlinked,
                        ...
                        crate::scheduler::core::BluetoothDtmSchedulerSoftwareListRemovalRecheck::Pending(
                            unlinked,
                        ) => match mailbox.rearm(critical_section, key, unlinked) {
                            BluetoothPostUnlinkRearm::Armed(awaiting) => {
                        ...
                        crate::scheduler::core::BluetoothDtmSchedulerSoftwareListRemovalRecheck::Ready(
                            ready,
            ...
            match published {
                ...
                BluetoothPrimaryPublishedInterruptStep::Scheduler { event, .. } => {
                    match runtime.join_dtm_software_list_removal(unlinked, event) {
                        crate::scheduler::core::BluetoothDtmSchedulerSoftwareListRemovalJoin::SchedulerIdentityMismatch {
                            unlinked,
                            event,
                        ...
                        crate::scheduler::core::BluetoothDtmSchedulerSoftwareListRemovalJoin::Pending(
                            unlinked,
                        ) => match mailbox.rearm(critical_section, key, unlinked) {
                            BluetoothPostUnlinkRearm::Armed(awaiting) => {
                        ...
                        crate::scheduler::core::BluetoothDtmSchedulerSoftwareListRemovalJoin::Ready(
                            ready,
                        ) => BluetoothDtmSoftwareListRemovalPublishedStep::Ready { ready },
                    }
                }
