//! Selected schema-v51 linked-IR evidence used by the manual register report.
...
mod tests {
    ...
    #[test]
    fn loads_and_merges_schema_v51_field_evidence() {
    ...
    fn rejects_schema_drift_and_invalid_field_masks() {
        ...
        assert!(error.to_string().contains("expected schema_version 51"));
