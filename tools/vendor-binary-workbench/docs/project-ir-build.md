...
`pseudo-rust` is optional; the schema-v44 random-access bundle is always generated.
...
Artifact identities and digests remain embedded in the schema-v44 report, so a
...
generated linked-IR bundle remains a separate schema-v44 project artifact; the
...
valid entry contract, generated schema-v44 output and an optional pseudo-Rust
