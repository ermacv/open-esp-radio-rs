...
impl<
    ...
    const STAGE_CAPACITY: usize,
    const STAGE_SLOTS: usize,
> StagedRxPublisher<'pool, 'queue, M, QUEUE_DEPTH, STAGE_CAPACITY, STAGE_SLOTS>
{
    ...
    fn try_send(
        ...
        match self {
            ...
            Self::StaAp {
                ...
                .try_send(StaApStagedRxFrame::classify(frame, *ingress, *addresses))
