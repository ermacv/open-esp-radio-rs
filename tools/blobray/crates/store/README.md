...
Projects require metadata schema 12 and journal schema 13; earlier/future formats
...
Run schema 13 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 12.
