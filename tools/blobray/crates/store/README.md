...
Projects require metadata schema 10 and journal schema 11; earlier/future formats
...
Run schema 11 carries the admitted operation, optional concrete scenario
...
The analyses table and publication transaction remain metadata schema 10.
