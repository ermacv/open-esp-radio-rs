...
impl StageOutcome {
    pub(super) const fn blocks_dependants(&self) -> bool {
...
pub(super) struct PipelineSummary {
    ...
    pub(super) not_configured: usize,
}
...
pub(super) fn report(name: &str, outcome: &StageOutcome, summary: &mut PipelineSummary) {
