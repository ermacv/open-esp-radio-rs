...
`pseudo-rust` is optional; schema-v37 JSON is always generated.
...
Artifact identities and digests remain embedded in the schema-v37 report, so a
...
generated linked-IR JSON remains a separate schema-v37 project artifact; the
...
valid entry contract, generated schema-v37 output and an optional pseudo-Rust
