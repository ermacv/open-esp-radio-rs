...
pub fn run(output: &Path, context: &Context<'_>, phy: PhyExpectation) -> Result<()> {
...
fn require_calibrated(evidence: oer_hil_protocol::StationPauseEvidence) -> Result<()> {
...
mod tests {
    use super::*;
    use oer_hil_protocol::{StationPauseEvidence, StationPauseResult, StationPhyTrackingEvidence};
    #[test]
