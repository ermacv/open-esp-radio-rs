...
impl Esp32s31RadioOwnerArena {
    ...
    ) -> Result<crate::wifi::channel::RadioChannelHal<'arena, P>, Esp32s31RadioOwnerArenaError>
    {
        match self.state() {
        ...
        Ok(crate::wifi::channel::RadioChannelHal::from_published(
            platform, registers,
        ))
    }
    ...
    pub fn try_wifi_mac_hal(
        &self,
    ) -> Result<crate::wifi::mac::WifiMacHal<'_>, Esp32s31RadioOwnerArenaError> {
        match self.state() {
            Esp32s31RadioOwnerArenaState::Empty => {
                return Err(Esp32s31RadioOwnerArenaError::MissingOwner);
            }
        ...
        let owner = RefMut::filter_map(slot, Option::as_mut)
            .map_err(|_| Esp32s31RadioOwnerArenaError::MissingOwner)?;
        let registers = RefMut::map(owner, RadioRuntimeOwner::pac_mut);
        Ok(crate::wifi::mac::WifiMacHal::from_published(registers))
    }
    ...
    pub fn try_station_receive_policy_snapshot(
        &self,
    ) -> Result<crate::wifi::mac::MacStaReceivePolicySnapshot, Esp32s31RadioOwnerArenaError> {
    ...
    pub fn try_receive_statistics_snapshot(
        &self,
    ) -> Result<crate::wifi::mac::MacRxStatisticsSnapshot, Esp32s31RadioOwnerArenaError> {
    ...
    pub fn try_receive_dma_snapshot(
        &self,
    ) -> Result<crate::wifi::mac::MacRxDmaSnapshot, Esp32s31RadioOwnerArenaError> {
    ...
    pub fn try_configure_station_receive_policy(
        ...
        self.try_with_mut(|registers| {
            crate::wifi::mac::WifiMacHal::from_owned(registers)
    ...
    pub fn try_configure_station_esp_now_receive_policy(
        ...
        self.try_with_mut(|registers| {
            let mut hal = crate::wifi::mac::WifiMacHal::from_owned(registers);
    ...
    pub fn try_install_station_ccmp_entry(
        ...
        temporal_key: &[u8; 16],
    ) -> Result<crate::wifi::mac::MacKeyInstallOutcome, Esp32s31RadioOwnerArenaError> {
        self.try_with_mut(|registers| {
            crate::wifi::mac::WifiMacHal::from_owned(registers).install_station_ccmp_entry(
                index,
                identity,
                temporal_key,
            )
    ...
    pub fn try_install_access_point_ccmp_entry(
        ...
        self.try_with_mut(|registers| {
            crate::wifi::mac::WifiMacHal::from_owned(registers).install_access_point_ccmp_entry(
                index,
                identity,
                temporal_key,
            )
    ...
    pub fn try_clear_ccmp_entry(&self, index: u8) -> Result<(), Esp32s31RadioOwnerArenaError> {
        self.try_with_mut(|registers| {
            crate::wifi::mac::WifiMacHal::from_owned(registers).clear_ccmp_entry(index);
        })
    }
    ...
    pub fn try_ccmp_entry_is_valid(
        ...
        self.try_with_mut(|registers| {
            crate::wifi::mac::WifiMacHal::from_owned(registers).ccmp_entry_is_valid(index)
        })
    }
...
impl<'arena> Esp32s31RadioAccess<'arena> {
    ...
    ) -> Result<crate::wifi::channel::RadioChannelHal<'access, P>, Esp32s31RadioOwnerArenaError>
    {
    ...
    pub fn try_wifi_mac_hal(
        &self,
    ) -> Result<crate::wifi::mac::WifiMacHal<'arena>, Esp32s31RadioOwnerArenaError> {
