...
pub struct RunHistoryEntry {
    ...
    #[serde(default)]
    pub replayed_from_runs: Vec<String>,
    pub cell_id: String,
    pub device_id: String,
    pub suite_counts: Option<SuiteCounts>,
    pub run_directory: PathBuf,
    pub suite_report: Option<PathBuf>,
...
pub struct ScenarioTrend {
    ...
    pub flaky: bool,
    pub consecutive_non_passed: usize,
    pub last_outcome: Outcome,
    pub last_run_id: String,
}

#[derive(Clone, Debug, Deserialize, Eq, PartialEq, Serialize)]
pub struct MeasurementTrend {
    pub scenario: String,
...
pub struct HistoryReport {
    pub schema: u16,
    pub target: String,
    pub source_watermark_unix_millis: u64,
...
pub fn rebuild(root: &Path, target: &str) -> Result<HistoryCompletion> {
    rebuild_at(&root.join("target/hil").join(target), target)
}

pub fn rebuild_at(target_directory: &Path, target: &str) -> Result<HistoryCompletion> {
