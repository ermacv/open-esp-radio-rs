...
fn at(us: u32) -> oer_esp32s31_bluetooth::SchedulerInstant {
    oer_esp32s31_bluetooth::SchedulerInstant::from_image(us)
}
...
fn real_epoch_projects_both_window_edges_across_raw_controller_wrap() {
    use oer_esp32s31_bluetooth::{
        ControllerSchedulerEpoch, ControllerTimeSample, scheduler::SchedulerRawWindow,
    };
