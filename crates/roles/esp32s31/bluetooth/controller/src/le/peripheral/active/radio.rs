...
use {crate::controller as ctrl, oer_esp32s31_bluetooth::scheduler as sched};
...
fn update_procedure_deadline(
    ...
    reference: Option<oer_esp32s31_bluetooth::SchedulerInstant>,
...
impl<'a, S: SchedulerRunInterruptStorage, const N: usize> Radio<'a, S, N> {
    ...
    fn complete_ready(
        ...
        evidence: Evidence,
        termination_reference: Option<oer_esp32s31_bluetooth::SchedulerInstant>,
        link: &mut LinkState<'_>,
    ) -> Step<'a, S, N> {
        use PeripheralConnectionActiveFaultCause as Cause;
