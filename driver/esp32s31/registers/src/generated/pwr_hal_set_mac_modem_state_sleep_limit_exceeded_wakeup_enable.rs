...
// Source vendor symbol: pwr_hal_set_mac_modem_state_sleep_limit_exceeded_wakeup_enable
use open_esp_radio_esp32s31_pac as pac;

#[inline(always)]
pub fn generated_pwr_hal_set_mac_modem_state_sleep_limit_exceeded_wakeup_enable(
    ...
    unsafe {
        wifi_mac_rtc_timer_update_registers
            ...
            .write_with_zero(|writer| {
                writer.bits(((read0 & 0xffff7fff_u32) | 0x00008000_u32) as u32)
            });
    }
    arg0
}
