...
impl<P> RadioChannelHal<'_, P> {
    ...
    pub fn request_mac_stop(&mut self) {
        crate::wifi::mac::WifiMacHal::from_owned(self.registers.get_mut()).request_channel_stop();
    }

    pub fn mac_active_state(&mut self) -> u8 {
        crate::wifi::mac::WifiMacHal::from_owned(self.registers.get_mut()).channel_active_state()
    }

    pub fn restart_mac(&mut self) -> u8 {
        crate::wifi::mac::WifiMacHal::from_owned(self.registers.get_mut())
