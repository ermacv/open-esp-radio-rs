...
/// sticky quarantine.
pub trait StandaloneEspNowChannelControl<H, P> {
    type Error;
...
#[cfg(target_arch = "riscv32")]
impl<P, D, O> StandaloneEspNowChannelControl<oer_esp32s31_hal::owner::RadioRuntimeOwner, P>
    for StandaloneEspNowPhyChannelControl<'_, '_, D, O>
where
    D: oer_esp32s31_phy::PhyAsyncDelay,
    O: oer_esp32s31_phy::PhyTargetObserver,
{
    type Error = oer_esp32s31_phy::PhyTargetPortError;
