...
pub use open_esp_radio_pac_esp32s31::{
    mac::{
        ...
        RX_LAST_DESCRIPTOR, RX_LAST_DESCRIPTOR_HIGH, RX_NEXT_DESCRIPTOR, TX_COMPLETE_ALTERNATE,
        TX_COMPLETE_ALTERNATE_Q0, TX_COMPLETE_AUX_A, TX_COMPLETE_AUX_A_Q0, TX_COMPLETE_AUX_B,
        TX_COMPLETE_AUX_B_Q0, TX_COMPLETE_AUX_C, TX_COMPLETE_AUX_C_Q0, TX_COMPLETE_CLEAR,
        TX_COMPLETE_PRIMARY, TX_COMPLETE_PRIMARY_Q0, TX_COMPLETE_STATE, TX_Q0_CONFIG,
        TX_Q0_CONTROL, TX_Q0_LENGTH_CONTROL, TX_Q0_PLCP1, TX_Q0_POWER, TX_Q0_PPDU_CONTROL,
        TX_Q0_PROTECTION, TX_Q0_PTI, TX_Q_CONFIG, TX_Q_CONTROL, TX_Q_LENGTH_CONTROL, TX_Q_PLCP1,
