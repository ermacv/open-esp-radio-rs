...
impl ProjectFixture {
    pub fn checked_inputs(repository: &std::path::Path, label: &str, revisions: bool) -> Self {
        ...
        let fixture = Self {
            manifest: root.join("verification/vendor/targets/esp32s31/vendor-project.toml"),
            root,
        };
        ...
        let source = repository.join("verification/vendor/targets/esp32s31");
