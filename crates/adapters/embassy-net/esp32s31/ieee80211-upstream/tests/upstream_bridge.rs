...
use oer_esp32s31_ieee80211_embassy_net_upstream::{
    DualEmbassyDatapathNetwork, EmbassyDatapathNetwork,
};
...
fn physical() -> oer_esp32s31_ieee80211_runtime::datapath::PinnedTxConsumer<
    'static,
    NoopRawMutex,
    FRAME_CAPACITY,
    HEADROOM,
...
fn upstream_rx_parts_use_the_same_radio_publication_contract() {
    ...
    network
        ...
        .try_send_parts(
            oer_esp32s31_ieee80211_runtime::datapath::network::EthernetFrameParts {
                destination: [0x11; 6],
                source: [0x22; 6],
                ether_type: 0x0800,
                payload: &[0x33; 5],
