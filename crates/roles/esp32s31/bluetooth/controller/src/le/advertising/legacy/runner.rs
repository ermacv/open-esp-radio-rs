...
use {
    crate::{
        controller::{
            ...
            LegacyAdvertisingControllerPreparationError,
            LegacyAdvertisingControllerPreparationOutcome,
            LegacyAdvertisingControllerPreparationPending,
            LegacyAdvertisingControllerPreparationStep, SchedulerRunInterruptStorage,
            boot::{
        ...
        le::advertising::{
            ...
            scheduler::{
                LegacyAdvertisingEmptySchedulerMergePrepared,
                LegacyAdvertisingSchedulerHeadPublished,
            },
        },
    },
    oer_esp32s31_bluetooth::scheduler::SchedulerHeadPublicationError,
};
    ...
    S: SchedulerRunInterruptStorage,
{
    command: LegacyAdvertisingDeferredStart<'runtime>,
    task: ControllerPublishedTaskService<'runtime, S, SCHEDULER_CAPACITY>,
    running: oer_esp32s31_bluetooth::scheduler::core::SingleItemSchedulerRunning<
