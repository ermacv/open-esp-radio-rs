...
| Path | Purpose |
| --- | --- |
| `register-model/` | Shared schema-2 register model loader and clean SVD encoder |
| `pac-gen/` | Reproducible ESP32-S31 PAC generation from the project model and target add-on |
